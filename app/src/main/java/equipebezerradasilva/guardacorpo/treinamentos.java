...
public class treinamentos extends AppCompatActivity implements Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] lista3 = new int[]{
                ...
                R.drawable.btntreinamentos1, R.drawable.btntreinamentos2, R.drawable.btntreinamentos3, R.drawable.btntreinamentos4,
                R.drawable.btntreinamentos5, R.drawable.btntreinamentos5, R.drawable.btntreinamentos7, R.drawable.btntreinamentos8,
                R.drawable.btntreinamentos9, R.drawable.btntreinamentos10, R.drawable.btntreinamentos11, R.drawable.btntreinamentos12,
        };
